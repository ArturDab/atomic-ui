...
export function ChatMessage({ role, content, timestamp, userInitials = 'U' }: ChatMessageProps) {
  ...
  return (
    <div className={cn('flex gap-3', isAssistant ? 'itely-start' : 'itely-start flex-row-reverse')}>
      <div className={cn(
        'w-7 h-7 rounded-full flex itely-center justify-center shrink-0 text-xs font-semibold mt-0.5',
      ...
      <div className={cn('flex flex-col gap-1 max-w-[85%]', !isAssistant && 'itely-end')}>
        <div className={cn(
