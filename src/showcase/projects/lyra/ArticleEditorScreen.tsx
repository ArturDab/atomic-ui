...
function BlockRenderer({ block, isSelected, onClick }: {
  ...
  switch (block.type) {
    ...
    case 'image': return (
      <div className="my-6">
        <div className="rounded-xl border bg-muted/30 aspect-video flex flex-col itely-center justify-center gap-2">
    ...
    case 'html': return (
      <div className="my-4 rounded-xl border overflow-hidden">
        <div className="flex itely-center gap-2 px-3 py-2 border-b bg-muted/40">
    ...
    case 'ai-generated': return (
      <div className="my-4 relative" onMouseUp={handleMouseUp}>
        <div className="absolute -left-6 top-1.5 w-4 h-4 rounded-full bg-amber-100 border border-amber-200 flex itely-center justify-center">
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="h-14 border-b flex itely-center px-4 gap-3 shrink-0 bg-white">
        ...
        <div className="flex itely-center gap-1.5 shrink-0">
          <span className="text-xs text-foreground/60 flex itely-center gap-1">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="h-9 border-b flex itely-center px-4 gap-2 shrink-0 bg-muted/20">
            <button
              onClick={() => setShowBlocks(o => !o)}
              className={cn('flex itely-center gap-1.5 text-xs px-2.5 py-1 rounded-md transition-colors',
          ...
          <ScrollArea className="flex-1">
            <div className="max-w-2xl mx-auto px-8 py-10 relative">
              ...
              {/* Add block button */}
              <div className="flex itely-center gap-2 mt-6 group">
                <div className="flex-1 h-px bg-border" />
                <button
                  onClick={() => setShowBlocks(true)}
                  className="flex itely-center gap-1.5 text-xs text-muted-foreground/50 hover:text-muted-foreground border border-dashed rounded-lg px-3 py-1.5 transition-colors group-hover:border-border">
