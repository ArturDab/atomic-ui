...
export const THEMES: Theme[] = [
  ...
  // ── Zen – Cool Mist (oparty na badaniach) ────────────────────────────────
  // Goldstein 1942 + Elliot 2015: niebieski obniża tętno i ciśnienie
  // IJoHCI 2024: ~4500K = optimum skupienia bez zmęczenia wzroku
  // Valdez & Mehrabian 1994: niska saturacja akcentu (~28% S) nie pobudza
  {
    id: 'zen',
    name: 'Zen',
    tagline: 'Cool Mist · Naukowo spokojny',
    radius: '10px',
    editorFont:     BASE_TYPOGRAPHY['--editor-font'],
    editorFontSize: BASE_TYPOGRAPHY['--editor-size'],
    vars: {
      ...
      '--ring':                '210 28% 44%',
      '--sidebar':             '210 18% 91%',
      '--sidebar-light':       '210 14% 94%',
      '--sidebar-header':      '210 20% 87%',
