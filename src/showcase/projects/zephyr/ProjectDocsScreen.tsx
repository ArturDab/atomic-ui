...
import { ClipboardCopy, Check, Pencil, BookOpen, Code2, Download, Upload, Wind, ExternalLink, Rocket } from 'lucide-react'
    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-8 py-8 space-y-6">
          ...
          <ConfigToolbar values={values} storageKey="zephyr-docs-values" onChange={onChange} />
