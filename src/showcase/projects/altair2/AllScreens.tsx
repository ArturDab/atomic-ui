...
const SCREENS = [
  { path: 'al2-ai-chat',          label: 'AI Chat',                   Component: AIChatScreen },
  { path: 'al2-ai-chat-artifact',  label: 'AI Chat – z artefaktem',    Component: AIChatWithArtifactScreen },
  { path: 'al2-ai-teams',  label: 'AI Teams',  Component: AITeamsScreen },
  { path: 'al2-documents',  label: 'Dokumenty',  Component: DocumentsScreen },
  { path: 'al2-ai-studio',         label: 'AI Studio – galeria',    Component: AIStudioScreen },
  { path: 'al2-ai-studio-empty',    label: 'AI Studio – edytor pusty', Component: AIStudioEditorEmpty },
  { path: 'al2-ai-studio-filled',   label: 'AI Studio – edytor treść', Component: AIStudioEditorFilled },
]
  ...
  return (
    <div className="overflow-y-auto h-full bg-[#fafafa] px-8 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-xl font-semibold tracking-tight mb-1">Altair 2.0</h1>
