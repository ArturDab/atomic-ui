...
const STORAGE_KEY = 'manuscript-docs-values'
...
Widoki: 7 makiet, 3 motywy (Ink/Nova/Folio), 4 hooki w src/modules/manuscript/
...
## Moduły z Atomic UI
Źródło: github.com/ArturDab/atomic-ui (src/modules/manuscript/)
          ...
          {active === 'atomic' && (
            <>
              ...
              <div className="border-t pt-6 space-y-3">
                <h3 className="text-sm font-semibold">Stan projektu Manuscript</h3>
                {[
