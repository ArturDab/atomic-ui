...
// Widok: edytor pusty (formularz wypełniony, brak treści)
export function AIStudioEditorEmpty() {
  return <AIStudioEditorBase hasContent={false} />
}

// Widok: edytor z treścią (po generowaniu)
export function AIStudioEditorFilled() {
  return <AIStudioEditorBase hasContent={true} />
}
