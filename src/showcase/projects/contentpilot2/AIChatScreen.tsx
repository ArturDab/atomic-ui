 ...
 * 1. Split pane – wygenerowany artefakt (kod, dokument) otwiera się obok czatu
 * 2. Thread grouping – lista czatów pogrupowana datami (Dziś / Wczoraj / Wcześniej)
 * 3. Model w header, nie w paseku – zawsze widoczny, nie koliduje z inputem
 * 4. "Context" zamiast "Prompt systemowy" – bardziej zrozumiała etykieta
 * 5. Suggested prompts w empty state – skraca czas do pierwszego efektu
 */
...
import {
  Plus, Sparkles, Copy, ThumbsUp, ThumbsDown,
  RotateCcw, Clock, Coins, Send, Paperclip,
  PanelRight, ChevronDown, SlidersHorizontal, X,
  Code, FileText, Maximize2,
} from 'lucide-react'
...
const THREADS = {
  ...
  'Wcześniej': [
    ...
    { id: '6', title: 'Wyciągarka CSS-a (wkleić w konsoli)' },
    { id: '7', title: 'SEO meta tagi – Beezu.pl strona główna' },
  ],
}
...
const SUGGESTED = [
  'Napisz artykuł blogowy o trendach AI w 2025 roku',
  'Stwórz copy do kampanii email dla sklepu e-commerce',
  'Pomóż mi zoptymalizować ten tekst pod SEO',
  'Wygeneruj 5 pomysłów na posty na LinkedIn',
]
  ...
  return (
    <div className="flex h-full bg-background">
              ...
              <div key={group} className="mb-3">
                ...
                {threads.map(t => (
                  <button key={t.id} className={cn(
                    'w-full text-left px-4 py-2 text-sm transition-colors hover:bg-muted/50 rounded-none',
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Chat pane */}
        <div className={cn('flex flex-col overflow-hidden transition-all', artifactOpen ? 'w-[420px] shrink-0' : 'flex-1')}>
          ...
          <div className="h-14 border-b flex items-center px-4 gap-2 shrink-0">
            ...
            {/* Model selector – zawsze widoczny w headerze */}
          ...
          {/* Context bar (collapsed by default) */}
            ...
            <div className="py-6 px-4 space-y-6 max-w-xl mx-auto">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Artifact chip – zamiast bloku kodu w czacie */}
                  <button
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    <span className="text-[10px] text-muted-foreground flex items-center gap-1 mr-auto">
                      <Coins className="w-3 h-3" /> 2010 tok
                      <Clock className="w-3 h-3 ml-1" /> 9.6s
                    </span>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm leading-relaxed">
                    Oczywiście! Panel po prawej pokazuje teraz podgląd HTML na żywo. Możesz kliknąć w kod, żeby go edytować, albo skopiować gotowy szablon do swojego narzędzia.
                  </p>
                  <div className="flex items-center gap-1 mt-2">
                    <span className="text-[10px] text-muted-foreground flex items-center gap-1 mr-auto">
        ...
        {/* Artifact pane */}
        {artifactOpen && (
          <div className="flex-1 border-l flex flex-col overflow-hidden bg-muted/10">
            <div className="h-14 border-b flex items-center px-4 gap-3 shrink-0 bg-background">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => setArtifactOpen(false)}>
                <X className="w-4 h-4" />
              </Button>
            </div>
