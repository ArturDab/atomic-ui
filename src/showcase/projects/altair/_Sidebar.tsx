...
export function CPSidebar({ active = 'ai-chat' }: SidebarProps) {
  return (
    <aside className="w-14 border-r flex flex-col items-center py-3 shrink-0 h-full bg-background">
      <div className="w-8 h-8 rounded-md border bg-foreground flex items-center justify-center mb-4 shrink-0">
      ...
      <div className="flex flex-col items-center gap-2 px-2">
        <Tooltip>
          <TooltipTrigger asChild>
            <button className="w-full flex items-center justify-center py-2.5 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
