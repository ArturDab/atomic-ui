...
const MESSAGES: Message[] = [
  ...
  { id: '6', role: 'assistant', agentName: 'Copywriter', agentInitial: 'C', agentColor: AGENT_COLOR.c,
    text: '@ArturD, świetnie! Aby stworzyć coś naprawdę angażującego, dobrze byłoby wiedzieć trochę więcej. Kim dokładnie jest nasza grupa docelowa? Czy mamy pełną swobodę twórczą?' },
]
