...
import { Plus, Star, MessageSquarePlus, SlidersHorizontal, Trash2, Upload, MessageSquare, Users, ChevronRight, AtSign } from 'lucide-react'
...
const MESSAGES: Message[] = [
  ...
  { id: '2', role: 'assistant', agentName: 'Copywriter', agentInitial: 'C', agentColor: AGENT_COLOR.c,
    text: 'Cześć @ArturD, oczywiście, że jesteśmy gotowi do pracy! Daj mi znać, co konkretnie chcesz, żebym przygotował, i zajmę się tym od razu.',
    time: '2.2s' },
  ...
  { id: '6', role: 'assistant', agentName: 'Copywriter', agentInitial: 'C', agentColor: AGENT_COLOR.c,
    text: '@ArturD, świetnie! Aby stworzyć coś naprawdę angażującego, dobrze byłoby wiedzieć trochę więcej. Kim dokładnie jest nasza grupa docelowa? Czy chcemy skupić się na konkretnym aspekcie produktu, czy mamy pełną swobodę twórczą?' },
]
