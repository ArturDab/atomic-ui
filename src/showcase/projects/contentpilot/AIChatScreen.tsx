...
const CHAT_LIST = [
  ...
  { id: '4',  title: 'Sprawdzam, czy wszystko działa...', time: '20 mar' },
  { id: '5',  title: 'COPY & PASTE THIS PROMPT INTO AI...', time: '20 mar' },
  { id: '6',  title: 'Role: You are a World-Class UI/UX Designer...', time: '20 mar' },
  { id: '7',  title: 'Role: You are a World-Class UI/UX Designer...', time: '20 mar' },
  ...
  { id: '12', title: 'Napisz bardzo szczegółowy przewodnik...', time: '20 mar' },
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm" className="h-9 gap-2 text-sm">
          <SlidersHorizontal className="w-4 h-4" /> Parametry
        </Button>
      </PopoverTrigger>
...
export default function AIChatScreen() {
  ...
  const configBar = (
    <div className="flex items-center gap-2">
      ...
      <div className="ml-auto"><ParamsPopover /></div>
    </div>
  )
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      {/* TopBar – część UI ContentPilot */}
      <TopBar crumbs={[{ label: 'Strona główna' }, { label: 'AI Chat' }]} />

      {/* Główny układ – sidebar + content */}
