...
const MODULES = [
  { name: 'Lyra', hooks: 4, types: 12, screens: 7, status: 'ready' },
]
...
export default function Home() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-8 space-y-10">
      ...
      {/* Header */}
      <div className="flex itely-start justify-between">
        <div>
          <div className="flex itely-center gap-2 mb-1">
            <div className="w-6 h-6 rounded-md bg-foreground flex itely-center justify-center">
        ...
        <div className="flex itely-center gap-3 text-xs text-muted-foreground">
          <span className="flex itely-center gap-1"><FileText className="w-3.5 h-3.5" /> {atomCount} atomów</span>
          <span className="flex itely-center gap-1"><Blocks className="w-3.5 h-3.5" /> {blockCount} bloków</span>
          <span className="flex itely-center gap-1"><Box className="w-3.5 h-3.5" /> {MODULES.length} moduł</span>
        </div>
      </div>
      ...
      <section>
        <div className="flex itely-center justify-between mb-4">
          ...
          <Link to="/projects" className="text-xs text-muted-foreground hover:text-foreground flex itely-center gap-1 transition-colors">
            ...
            return (
              <Link key={p.slug} to={`/projects/${p.slug}`}
                ...
                <div className="flex itely-start justify-between mb-3">
                  <div className={cn('w-9 h-9 rounded-lg border flex itely-center justify-center', p.color)}>
                ...
                <div className="flex itely-center gap-3 text-[10px] text-muted-foreground">
                  ...
                  {p.phases.design && (
                    <span className="flex itely-center gap-1 text-blue-600">
      ...
      <section>
        <div className="flex itely-center justify-between mb-4">
          ...
          <Link to="/modules" className="text-xs text-muted-foreground hover:text-foreground flex itely-center gap-1 transition-colors">
        ...
        <div className="space-y-2">
          {MODULES.map(m => (
            <Link key={m.name} to="/modules"
              className="flex itely-center gap-4 p-4 border rounded-xl bg-white hover:border-foreground/25 hover:shadow-sm transition-all group">
              <div className="w-9 h-9 rounded-lg bg-emerald-50 border border-emerald-200 flex itely-center justify-center">
          ...
          <div className="flex itely-center gap-4 p-4 border border-dashed rounded-xl text-muted-foreground">
            <div className="w-9 h-9 rounded-lg bg-muted border border-dashed flex itely-center justify-center">
              <Sparkles className="w-4 h-4" />
            </div>
            <div>
              <p className="text-sm font-medium">AI Chat, AI Studio, Documents</p>
              <p className="text-xs mt-0.5">Planowane – po domknięciu Altair 2.0</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="flex itely-center justify-between mb-4">
          ...
          <Link to="/blocks" className="text-xs text-muted-foreground hover:text-foreground flex itely-center gap-1 transition-colors">
            Wszystkie <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
      ...
      <section>
        <div className="flex itely-center justify-between mb-4">
          ...
          <Link to="/all" className="text-xs text-muted-foreground hover:text-foreground flex itely-center gap-1 transition-colors">
